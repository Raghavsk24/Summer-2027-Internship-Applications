  ...
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Developed \emph{REST API} endpoints in \emph{FastAPI} querying \textbf{600K+ documents} on \emph{Elasticsearch} in \textbf{under 1 second}}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     \textbf{Languages \& Frameworks}{: Python, Java, JavaScript, SQL, Node.js, React, C++, HTML/CSS, FastAPI, Flask} \\
     \textbf{Databases \& Cloud}{: Docker, GitHub, AWS, PostgreSQL, MySQL, Elasticsearch, Firebase, Supabase, Google Cloud} \\
     \textbf{AI/ML}{: PyTorch, TensorFlow, Keras, scikit-learn, OpenCV, Grad-CAM, Hugging Face, Claude API, Gemma 4, RAG} \\
     \textbf{Tools \& Practices}{: API Development, Claude Code, Codex, Agile, VS Code, Figma, Kaggle, Google Calendar API} \\
     \textbf{Concepts}{: REST APIs, Full-Stack Development, Unit Testing, Data Pipelines, Data Ingestion, ETL, Data Quality}
    }
 \end{itemize}
 \vspace{3.53pt}
