...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     \textbf{Languages \& Frameworks}{: SQL, C++, Java, Python, FastAPI, Flask, JavaScript, HTML/CSS, Next.js, React} \\
     \textbf{Databases \& Cloud}{: PostgreSQL, MySQL, Git, GitHub, Elasticsearch, Firebase, Supabase, AWS, Google Cloud} \\
     ...
     \textbf{Concepts}{: Unit Testing, REST APIs, Full-Stack Development, Data Pipelines, Data Ingestion, ETL, Data Quality}
    }
 \end{itemize}
 \vspace{3.53pt}
