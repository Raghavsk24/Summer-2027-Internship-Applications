...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Built a scalable SaaS platform on \textbf{AWS} to automate research \& case-writing in competitive high school debate, reaching \textbf{10K+ users}, using \textbf{Agile} development to continuously deploy new iterations with team of 10 engineers}
...
\section{Projects}
    ...
    \resumeProjectHeading
          ...
          \resumeItemListStart
            ...
            \resumeItem{Wrote \emph{JSON schema} for \textbf{Claude Sonnet 4.6 VLM} to extract features (condition, brand, model, year) that define the pricing algorithm and filter out non-truck images. Fine-tuned across \textbf{30 independent iterations of RLHF}}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     \textbf{Languages}{: Java, Python, C++, HTML/CSS, SQL, Javascript} \\
     \textbf{Frameworks/ Platforms}{: FastAPI, Flask, Next.js, React, Supabase, HuggingFace, AWS, Google Cloud, Vercel} \\
     \textbf{Developer Tools}{: Git (CI/CD), GitHub, Docker, VS Code, Arduino IDE, Kaggle, Figma, Bun, Claude Code, Codex} \\
     \textbf{AI/ML}{: TensorFlow, Keras, scikit-learn, OpenCV, Grad-CAM, Gemma 4, Claude API, Vercel AI SDK, RAG}
    }
 \end{itemize}
 \vspace{3.53pt}
