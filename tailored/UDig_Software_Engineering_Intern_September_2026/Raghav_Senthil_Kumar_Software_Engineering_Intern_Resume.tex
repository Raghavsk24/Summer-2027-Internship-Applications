  ...
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        ...
        \resumeItem{Integrated the \emph{OpenAlex} and \emph{Semantic Scholar} \emph{REST APIs} into a pipeline that resolves papers \& backfills metadata}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     \textbf{Languages \& Frameworks}{: Python, Java, JavaScript, SQL, C++, HTML/CSS, FastAPI, Flask, Next.js, React} \\
     \textbf{Databases \& Cloud}{: Git, GitHub, PostgreSQL, MySQL, AWS, Google Cloud, Elasticsearch, Firebase, Supabase} \\
     ...
     \textbf{Concepts}{: REST APIs, Unit Testing, Full-Stack Development, Data Pipelines, Data Ingestion, ETL, Data Quality}
    }
 \end{itemize}
 \vspace{3.53pt}
