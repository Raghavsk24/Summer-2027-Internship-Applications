  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textbf{Activities:} Disruption Lab, SIGRobotics, AI Alignment, BuildIllinois, Innovation LLC}
      \resumeItemListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Analyzed 3 years of TikTok data (\textbf{200+ posts}) on \emph{Power BI} and \emph{Microsoft Excel} to find patterns in outreach}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     ...
     \textbf{Frameworks/ Platforms}{: FastAPI, Flask, Next.js, React, Node.js, Supabase, Vercel, MySQL, PostgreSQL} \\
     \textbf{Developer Tools}{: Git (CI/CD), Docker, VS Code, Arduino IDE, Kaggle, Figma, Bun, Claude Code, Codex} \\
     \textbf{AI/ML}{: TensorFlow, Keras, scikit-learn, OpenCV, Grad-CAM, Claude API, RAG, API Development}
    }
 \end{itemize}
 \vspace{3.53pt}
