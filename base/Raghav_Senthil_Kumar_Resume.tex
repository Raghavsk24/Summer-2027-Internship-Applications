...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     ...
     \textbf{Frameworks \& Databases}{: FastAPI, Flask, React, Next.js, Node.js, PostgreSQL, Elasticsearch, Firebase, Supabase} \\
     \textbf{Cloud \& Tools}{: AWS, Google Cloud, Vercel, Docker, Git/GitHub, CI/CD, REST APIs, Unit Testing, Claude Code} \\
     \textbf{AI/ML}{: PyTorch, TensorFlow, Keras, scikit-learn, OpenCV, Hugging Face, pandas, NumPy, Claude API, LLMs, RAG}
    }
 \end{itemize}
 \vspace{3.53pt}
