...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     ...
     \textbf{Frameworks/Platforms}{: FastAPI, Flask, Next.js, React, Firebase, Supabase, HuggingFace, Google Cloud, Vercel} \\
     \textbf{Developer Tools}{: Git/GitHub, Docker, VS Code, Arduino IDE, Kaggle, Figma, Bun, Claude Code, Codex} \\
     \textbf{AI/ML}{: TensorFlow, PyTorch, Keras, scikit-learn, OpenCV, Claude AI SDK, NumPy, pandas, GenAI, RAG}
    }
 \end{itemize}
 \vspace{3.53pt}
