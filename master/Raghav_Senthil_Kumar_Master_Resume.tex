  ...
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItem{\textbf{Activities:} Disruption Lab, SIGRobotics, AI Alignment, Agentic AI, BuildIllinois, Innovation LLC, Agentic AI}
      \resumeItemListEnd
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeProjectHeading
      ...
      \resumeItemListStart
        \resumeItem{Built the document search engine (\emph{Python FastAPI}) for a competitive high school debate research SaaS platform hosted on \emph{AWS}, developed by an \emph{Agile} team of \textbf{10 engineers} and drawing \textbf{10K+ site visitors}} % core | tags: backend, search, product
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \item{
     ...
     \textbf{Frameworks/Platforms}{: FastAPI, Flask, React, React Flow, Next.js, Node.js, PostgreSQL, MySQL, Elasticsearch, Supabase, Firebase, AWS, Google Cloud, Vercel, Google Calendar API, OpenAlex API, Semantic Scholar API} \\
     \textbf{DevTools}{: Git, GitHub, Docker, CI/CD, VS Code, Claude Code, Codex, Figma, Bun, Arduino IDE, Kaggle} \\
     \textbf{AI/ML}{: PyTorch, TensorFlow, Keras, scikit-learn, OpenCV, Grad-CAM, Hugging Face, Claude API, Gemma 4, Vercel AI SDK, Supermemory} \\
     \textbf{Data \& Analytics}{: pandas, NumPy, Power BI, Microsoft Excel, Hootsuite, A/B Testing} \\
     \textbf{Concepts/Practices}{: Object-Oriented Programming, REST APIs, API Development, Full-Stack Development, Unit Testing, Authentication, Agile, Data Pipelines, Data Ingestion, ETL, Data Quality, Data Validation, Data Cleaning, Data Mining, Data Visualization, Statistical Analysis, LLMs, RAG, Generative AI, Prompt Engineering, AI Agents}
    }
 \end{itemize}
